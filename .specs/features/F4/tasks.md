...
- 🟡 **F4.20** — Round 1 (wiring smoke) shipped — `pipeline agent run-once` end-to-end no-op em sub-segundo (NFR-01 verificado). Round 2 (cold 153k fixture) e Round 3 (fault-injection demo) deferidos — gastam quota LLM e dependem de WIRING-3. Detalhes em `.specs/features/F4/SMOKE.md`.
